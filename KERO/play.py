...
# 🔧 FIXED — النسخ الجديدة ما فيهاش JoinedGroupCallParticipant
...
async def aii(client: Client, message):
   ...
   try:
    ...
    chat_id = message.chat.id
    user_id = message.from_user.id if message.from_user else "AT_W2"
    videoid = None
    link = None
